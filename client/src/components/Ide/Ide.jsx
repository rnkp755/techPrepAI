            ...
            <div className="flex justify-between mx-8 py-1">
                <Menu>
                    <MenuButton className="min-w-56 inline-flex justify-between items-center gap-2 rounded-t-md bg-[#111826] py-1.5 px-3 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 focus:outline-none data-[hover]:bg-[#111826]/6 data-[open]:bg-[#1E2A47] data-[focus]:outline-1 data-[focus]:outline-white">
                        ...
                        <ChevronDown className="size-6 fill-white/60" />
                    </MenuButton>
                    <MenuItems
                        transition
                        anchor="bottom end"
                        ...
                        {languageOptions.map((language, index) => (
                            <MenuItem key={index}>
                                ...
                                >
                                    ...
                                    {languageIDX === index && (
                                        <CircleCheck className="size-6 fill-white/60" />
                                    )}
                                </button>
                            </MenuItem>
                        ))}
                ...
                <div className="flex items-center gap-2">
                    <div onClick={toggleTheme}>
                        {theme === "hc-black" ? (
                            <Sun className="size-8 fill-white/60 p-1 cursor-pointer hover:fill-black hover:bg-white rounded-full transition-all" />
                        ) : (
                    ...
                    <div onClick={runCode}>
                        {isCodeRunning ? (
                            <Pause className="size-8 fill-white/60 p-1 cursor-pointer hover:fill-black hover:bg-white rounded-full transition-all" />
                        ) : (
                            <Play className="size-8 fill-white/60 p-1 cursor-pointer hover:fill-black hover:bg-white rounded-full transition-all" />
                        )}
                    </div>
                </div>
            </div>
