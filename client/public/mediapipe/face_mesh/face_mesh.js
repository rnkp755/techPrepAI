...
*/
	...
	function sa(a) {
		for (; a.g.g; )
			try {
				var b = a.h(a.g);
				if (b)
					return (a.g.l = !1), { value: b.value, done: !1 };
			} catch (c) {
	...
	function Ia(a, b) {
		function c(k) {
			for (; d < a.length; ) {
				...
				if (!/^[\s\xa0]*$/.test(l))
					throw Error(
						"Unknown base64 encoding at char: " + l
					);
			}
			return k;
		}
	...
	function Va(a) {
		...
		if (za)
			(d = ya) ||
				(d = ya = new TextDecoder("utf-8", { fatal: !1 })),
	...
	function Xb(a) {
		...
		if (a.options) {
			...
			for (var c = b.next(); !c.done; c = b.next()) {
				...
				void 0 !== d &&
					(this.j[c] = "function" === typeof d ? d() : d);
			}
		}
	}
	v = Xb.prototype;
			...
			return O(c, function (m) {
				switch (m.g) {
					...
					case 2:
						...
						return N(
							m,
							createMediapipeSolutionsWasm(Module),
							6
						);
					case 6:
						d.h = m.h;
		...
		options: {
			...
			maxNumFaces: {
				...
				graphOptionXref: {
					calculatorType: "ConstantSidePacketCalculator",
					calculatorName:
						"ConstantSidePacketCalculatorNumFaces",
					fieldName: "int_value",
				},
			},
			refineLandmarks: {
				...
				graphOptionXref: {
					calculatorType: "ConstantSidePacketCalculator",
					calculatorName:
						"ConstantSidePacketCalculatorRefineLandmarks",
					fieldName: "bool_value",
				},
			},
